...
public class CarrinhoPessoaJuridica implements Carrinho {

    private PessoaJuridica clientePessoaJuridica;
    private List<Pedido> pedidos;
    private BigDecimal frete;
    private BigDecimal taxas;

    public CarrinhoPessoaJuridica(PessoaJuridica cliente) {
        this.clientePessoaJuridica = cliente;
    ...
    public void listarItensCarrinho() {
        ...
        System.out.println("Nome: " + this.clientePessoaJuridica.getNome());
        System.out.println("E-mail: " + this.clientePessoaJuridica.getEmail());
        System.out.println("Telefone: " + this.clientePessoaJuridica.getTelefone());
        System.out.println("----------------------------------------------------------------------------------------------------------------------------");
